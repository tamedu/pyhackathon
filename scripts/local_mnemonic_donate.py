...
from accounts import buildSignSendTx

from web3 import Web3, IPCProvider, HTTPProvider

'''
seed = "legal winner thank year wave sausage worth useful legal winner thank yellow"
ganache-cli --account="0xb1b314d4fedc41fa409d26eb15e4ea1b213a3e7951dd16d8701a35c783a4a594,999988880000000000000" -i 1 -l 990000000000
...
buildSignSendTx(donator.functions.donate, 3, value=5*(10**18), gas=99000)
